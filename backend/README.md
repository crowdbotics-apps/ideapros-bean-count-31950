...
## Project Structure
    ...
    ├── ideapros_bean_count_31950  # Django project configurations
...
1. Clone this repo and `cd ideapros_bean_count_31950`
...
2. Clone this repo and `cd ideapros_bean_count_31950`
